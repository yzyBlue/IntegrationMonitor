    ...
    return /** *** */ (function(modules) { // webpackBootstrap
        ...
        ([
            ...
            function(module, exports, __webpack_require__) {
                 ...
                 * 
                 * Provide sprintf-style format (only %s is supported) and arguments to
                 * provide information about what broke and what you were expecting.
                 * 
            ...
            function(module, exports, __webpack_require__) {
                 ...
                 * paths. Removing the logging code for production environments will keep
                 * the same logic and follow the same code paths.
                 */
            ...
            function(module, exports, __webpack_require__) {
                 ...
                 * 
                 * const routes = createRoutesFromReactChildren( <Route component={App}>
                 * <Route path="home" component={Dashboard}/> <Route path="news"
                 * component={NewsFeed}/> </Route> )
                 * 
                ...
                /**
                 * Creates and returns an array of routes from the given object which may be
                 * a JSX route, a plain object route, or an array of either.
                 */
            ...
            function(module, exports, __webpack_require__) {
                ...
                /**
                 * Attempts to match a pattern on the given pathname. Patterns may use the
                 * following special characters:
                 *  - :paramName Matches a URL segment up to the next /, ?, or #. The
                 * captured string is considered a "param" - () Wraps a segment of the URL
                 * that is optional - * Consumes (non-greedy) all characters up to the next
                 * character in the pattern, or to the end of the URL if there is none - **
                 * Consumes (greedy) all characters up to the next character in the pattern,
                 * or to the end of the URL if there is none
                 * 
                 * The function calls callback(error, matched) when finished. The return
                 * value is an object with the following properties:
                 *  - remainingPathname - paramNames - paramValues
                 */
                function matchPattern(pattern, pathname) {
                    // Ensure pattern starts with leading slash for consistency with
                    // pathname.
                    if (pattern.charAt(0) !== '/') {
                        pattern = '/' + pattern;
                    }
            ...
            function(module, exports) {
                ...
                /**
                 * Indicates that navigation was caused by some other action such as using a
                 * browser's back/forward buttons and/or manually manipulating the URL in a
                 * browser's location bar. This is the default.
                 * 
                 * See
            ...
            function(module, exports, __webpack_require__) {
                ...
                /**
                 * A <RouterContext> renders the component tree for a given router state and
                 * sets the history object and the current location in context.
                 */
                    ...
                    render: function render() {
                        ...
                        if (components) {
                            element = components.reduceRight(function(element, components, index) {
                                if (components == null) return element; // Don't create new
                                // children; use the
                                // grandchildren.
                                ...
                                if ((typeof components === 'undefined' ? 'undefined' : _typeof(components)) === 'object') {
                                    ...
                                    for (var key in components) {
                                        if (Object.prototype.hasOwnProperty.call(components, key)) {
                                            ...
                                            // custom createElement functions to know which named
                                            // component
                ...
                if (true) {
                    ...
                    if (canUseMembrane) {
                        deprecateObjectProperties = function deprecateObjectProperties(object, message) {
                            // Wrap the deprecated object in a membrane to warn on property
                            // access.
                            var membrane = {};
                            ...
                            var _loop = function _loop(prop) {
                                ...
                                // These properties are non-enumerable to prevent React dev tools
                                // from
                                // seeing them and causing spurious warnings when accessing them. In
                                // principle this could be done with a proxy, but support for the
                                // ownKeys trap on proxies is not universal, even among browsers
                                // that
            ...
            function(module, exports, __webpack_require__) {
                ...
                /**
                 * Returns a new createHistory function that may be used to create history
                 * objects that know how to handle URL queries.
                 */
                function useQueries(createHistory) {
                    return function() {
                        ...
                        function addQuery(location) {
                            ...
                            // TODO: Instead of all the book-keeping here, this should just
                            // strip the
            ...
            function(module, exports, __webpack_require__) {
                ...
                function createTransitionManager(history, routes) {
                    ...
                    // Signature should be (location, indexOnly), but needs to support
                    // (path,
                    // query, indexOnly)
                    ...
                    /**
                     * Registers the given hook function to run before leaving the given
                     * route.
                     * 
                     * During a normal transition, the hook function receives the next
                     * location as its only argument and must return either a) a prompt
                     * message to show the user, to make sure they want to leave the page or
                     * b) false, to prevent the transition.
                     * 
                     * During the beforeunload event (in browsers) the hook receives no
                     * arguments. In this case it must return a prompt message to prevent
                     * the transition.
                     * 
                     ...
                     * we update state and call the listener. We can also gracefully handle
            ...
            function(module, exports) {
                 ...
                 * https://github.com/rackt/react-router/issues/586
                 */
            ...
            function(module, exports, __webpack_require__) {
                ...
                /**
                 * A <Link> is used to create an <a> element that links to a route. When
                 * that route is active, the link gets the value of its activeClassName
                 * prop.
                 * 
                 ...
                 * 
                 * Links may pass along location state and/or query string parameters in the
                 * state/query props, respectively.
                 * 
                ...
                var Link = _react2.default.createClass({
                    ...
                    render: function render() {
                        ...
                        // Ignore if rendered outside the context of router, simplifies unit
                        // testing.
                ...
                function saveState(key, state) {
                    try {
                        ...
                        if (error.name === SecurityError) {
                            // Blocking cookies in Chrome/Firefox/Safari throws SecurityError on
                            // any
                ...
                function createHashHistory() {
                    ...
                    function startHashChangeListener(_ref) {
                        ...
                        function hashChangeListener() {
                            if (!ensureSlash()) return; // Always make sure hashes are preceeded
                            // with a /.
                    ...
                    return _extends({}, history, {
                        ...
                        registerTransitionHook: registerTransitionHook, // deprecated - warning
                        // is in createHistory
                        unregisterTransitionHook: unregisterTransitionHook, // deprecated -
                        // warning is in
                        // createHistory
            ...
            function(module, exports, __webpack_require__) {
                ...
                function createHistory() {
                    ...
                    function transitionTo(nextLocation) {
                        if (location && locationsAreEqual(location, nextLocation)) return; // Nothing
                        // to
                        // do.
                        ...
                        confirmTransitionTo(nextLocation, function(ok) {
                            if (pendingLocation !== nextLocation) return; // Transition was
                            // interrupted.

                            if (ok) {
                                // treat PUSH to current path like REPLACE to be consistent with
                                // browsers
                                ...
                                if (prevIndex !== -1 && nextIndex !== -1) go(prevIndex - nextIndex); // Restore
                                // the
                                // URL.
                            }
                        });
            ...
            function(module, exports, __webpack_require__) {
                ...
                /**
                 * An <IndexRoute> is used to specify its parent's <Route indexRoute> in a
                 * JSX route config.
                 */
            ...
            function(module, exports, __webpack_require__) {
                 ...
                 * component that may be used to cancel a transition or prompt the user for
                 * confirmation.
                 * 
            ...
            function(module, exports, __webpack_require__) {
                ...
                /**
                 * A <Route> is used to declare which components are rendered to the page
                 * when the URL matches a given pattern.
                 * 
                 * Routes are arranged in a nested tree structure. When a new URL is
                 * requested, the tree is searched depth-first to find a route whose path
                 * matches the URL. When one is found, all routes in the tree that lead to
                 * it are considered "active" and their components are rendered into the
                 * DOM, nested in the same order as in the tree.
                 */
            ...
            function(module, exports, __webpack_require__) {
                ...
                /**
                 * The RouteContext mixin provides a convenient way for route components to
                 * set the route in context. This is needed for routes that render elements
                 * that want to use the Lifecycle mixin to prevent transitions.
                 */
            ...
            function(module, exports, __webpack_require__) {
                ...
                /**
                 * A <Router> is a high-level API for automatically setting up a router that
                 * renders a <RouterContext> with all the props it needs each time the URL
                 * changes.
                 */
                ...
                var Router = _react2.default.createClass({
                    ...
                    handleError: function handleError(error) {
                        if (this.props.onError) {
                            ...
                            throw error; // This error probably occurred in getChildRoutes or
                            // getComponents.
                        }
                    },
                    componentWillMount: function componentWillMount() {
                    ...
                    render: function render() {
                        ...
                        // Only forward non-Router-specific props to routing context, as those
                        // are
            ...
            function(module, exports, __webpack_require__) {
                ...
                /**
                 * Runs all onEnter hooks in the given array of routes in order with
                 * onEnter(nextState, replace, callback) and calls callback(error,
                 * redirectInfo) when finished. The first hook to use replace short-circuits
                 * the loop.
                 * 
                 * If a hook needs to run asynchronously, it may use the callback function.
                 * However, doing so will cause the transition to pause, which could lead to
                 * a non-responsive UI if the hook is slow.
                 */
                ...
                /**
                 * Runs all onChange hooks in the given array of routes in order with
                 * onChange(prevState, nextState, replace, callback) and calls
                 * callback(error, redirectInfo) when finished. The first hook to use
                 * replace short-circuits the loop.
                 * 
                 * If a hook needs to run asynchronously, it may use the callback function.
                 * However, doing so will cause the transition to pause, which could lead to
                 * a non-responsive UI if the hook is slow.
            ...
            function(module, exports, __webpack_require__) {
                ...
                /**
                 * Returns an object of { leaveRoutes, changeRoutes, enterRoutes }
                 * determined by the change from prevState to nextState. We leave routes if
                 * either 1) they are not in the next state or 2) they are in the next state
                 * but their params have changed (i.e. /users/123 => /users/456).
                 * 
                 * leaveRoutes are ordered starting at the leaf route of the tree we're
                 * leaving up to the common parent route. enterRoutes are ordered from the
                 * top of the tree we're entering down to the leaf route.
                 * 
                 * changeRoutes are any routes that didn't leave or enter during the
                 * transition.
                 */
            ...
            function(module, exports, __webpack_require__) {
                ...
                function getComponentsForRoute(nextState, route, callback) {
                    ...
                    if (("development") !== 'production' && _deprecateObjectProperties.canUseMembrane) {
                        ...
                        // assign extra properties to the copy of the state object in both
                        // cases.
                ...
                /**
                 * Asynchronously fetches all components needed for the given router state
                 * and calls callback(error, components) when finished.
                 * 
            ...
            function(module, exports, __webpack_require__) {
                ...
                function pathIsActive(pathname, currentPathname) {
                    // Normalize leading slash for consistency. Leading slash on pathname
                    // has
                    ...
                    // Normalize the end of both path names too. Maybe `/foo/` shouldn't
                    // show
                ...
                function routeIsActive(pathname, routes, params) {
                    ...
                    for (var i = 0, len = routes.length; i < len; ++i) {
                        ...
                        if (remainingPathname !== null && pattern) {
                            ...
                            if (remainingPathname === '') {
                                // We have an exact match on the route. Just check that all the
                                // params
                                // match.
                ...
                /**
                 * Returns true if all key/value pairs in the given query are currently
                 * active.
                 */
                ...
                function isActive(_ref, indexOnly, currentLocation, routes, params) {
                    ...
                    // TODO: This is a bit ugly. It keeps around support for treating
                    // pathnames
                    ...
                    if (!pathIsActive(pathname, currentLocation.pathname)) {
                        // The path check is necessary and sufficient for indexOnly, but
                        // otherwise
            ...
            function(module, exports, __webpack_require__) {
                 ...
                 * 
                 * Note: You probably don't want to use this in a browser unless you're
                 * using server-side rendering with async routes.
                 */
                function match(_ref, callback) {
                    ...
                    transitionManager.match(location, function(error, redirectLocation, nextState) {
                        ...
                        // Defer removing the listener to here to prevent DOM histories from
                        // having
                        // to unwind DOM event listeners unnecessarily, in case callback renders
                        // a
            ...
            function(module, exports, __webpack_require__) {
                ...
                function matchRouteDeep(route, location, remainingPathname, paramNames, paramValues, callback) {
                    ...
                    // Only try to match the path if the route actually has a pattern, and
                    // if
                    ...
                    if (remainingPathname !== null && pattern) {
                        ...
                        // By assumption, pattern is non-empty here, which is the prerequisite
                        // for
                            ...
                            if (error) {
                                ...
                                matchRoutes(childRoutes, location, function(error, match) {
                                    if (error) {
                                        ...
                                        // A child route matched! Augment the match and pass it up the
                                        // stack.
                 ...
                 *  - routes An array of routes that matched, in hierarchical order - params
                ...
                function matchRoutes(routes, location, callback, remainingPathname) {
                    ...
                    if (remainingPathname === undefined) {
                        // TODO: This is a little bit ugly, but it works around a quirk in
                        // history
                        // that strips the leading slash from pathnames when using basenames
                        // with
                        // trailing slashes.
            ...
            function(module, exports, __webpack_require__) {
                ...
                /**
                 * Returns a new createHistory function that may be used to create history
                 * objects that know about routing.
                 * 
                 * Enhances history objects with the following methods:
                 *  - listen((error, nextState) => {}) - listenBeforeLeavingRoute(route,
                 * (nextLocation) => {}) - match(location, (error, redirectLocation,
                 * nextState) => {}) - isActive(pathname, query, indexOnly=false)
                 */
            ...
            function(module, exports, __webpack_require__) {
                ...
                var deepEqual = module.exports = function(actual, expected, opts) {
                    ...
                    if (actual === expected) {
                        ...
                        // 7.4. For all other Object pairs, including Array objects, equivalence
                        // is
                ...
                function objEquiv(a, b, opts) {
                    ...
                    // ~~~I've managed to break Object.keys through screwy arguments
                    // passing.
            ...
            function(module, exports, __webpack_require__) {
                 ...
                 * (pushState, replaceState, and the popstate event) to manage history. This
                 * is the recommended method of managing history in browsers because it
                 * provides the cleanest URLs.
                 * 
                 * Note: In browsers that do not support the HTML5 history API full page
                 * reloads will be used to preserve URLs.
                 */
                function createBrowserHistory() {
                    ...
                    function startPopStateListener(_ref) {
                        ...
                        function popStateListener(event) {
                            if (event.state === undefined) return; // Ignore extraneous
                            // popstate events in
                            // WebKit.
            ...
            function(module, exports) {
                ...
                /**
                 * Copyright 2015, Yahoo! Inc. Copyrights licensed under the New BSD
                 * License. See the accompanying LICENSE file for terms.
                 */
                'use strict';
                ...
                module.exports = function hoistNonReactStatics(targetComponent, sourceComponent) {
                    if (typeof sourceComponent !== 'string') { // don't hoist over string
                        // (html) components
